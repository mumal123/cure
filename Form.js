...
constructor(){
    ...
    this.greeting3input=createInput("Enter")
}
hide(){
this.greeting.hide();
}
display(){
    ...
    this.greeting.position(displayWidth/2,displayHeight/2-400);
    this.date.html("Date-  ")
    ...
    this.greeting3.position(displayWidth/2-640,displayHeight/4+150);
    this.greeting3input.position(displayWidth/2-640,displayHeight/4+200);
}
}